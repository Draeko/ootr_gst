...
{
    class JSONSometimesHint : TextBox
    {
        ObjectPointLabel InteractiveElement;
        ...
        public JSONSometimesHint(ObjectPointLabel interactiveElement)
        {
            InteractiveElement = interactiveElement;
            this.Name = interactiveElement.Name;
            this.Location = new Point(interactiveElement.X, interactiveElement.Y);

            this.BackColor = interactiveElement.BackColor;
            this.Font = new Font(interactiveElement.FontName, interactiveElement.FontSize, interactiveElement.FontStyle);
            this.ForeColor = interactiveElement.FontColor;
            this.Size = new Size(interactiveElement.Width, interactiveElement.Height);
            this.ContextMenuStrip = OptionMenu;
